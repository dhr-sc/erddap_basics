...
Many of the NOAA CoastWatch nodes offer training in satellite ocean data use. The primary target audiences for the course are scientists and managers who are involved in operational activities, but are not actively using satellite data in their work. The goal of the course is to provide participants the knowledge and tools they require to incorporate off-the-shelf satellite data products into their operational activities, without delving into the details of how the products are made.  
